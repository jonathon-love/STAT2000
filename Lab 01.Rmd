...
if ( ! require('jmv'))
  install.packages('jmv', repos='https://cloud.r-project.org')
...
Seventy-one swimmers finished the first day's qualifying heats in the men's 100m freestyle event at the 2000 Olympics in Sydney. The SPSS file *swimmers.sav* contains the times in seconds.
...
### 1.3 Self-study – practice analyses and reporting results
 ...
 - At the end of the two-year test period, the number of words in each toddler’s vocabulary is measured.  The data are in the SPSS file **Lab 01 - lts.sav**.
