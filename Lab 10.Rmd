...
where:
 ...
 - $\epsilon_i ~ N(0, \sigma^2)$ error term for ith individual ... our usual normally distributed random error term modelling any unexplained variation
...
It turns out that many statistical softwares can perform the recoding step we performed in section 10.1, automatically and invisibly, without us having to worry about it.

Ⓡ To fit this model in R, we simple go:
